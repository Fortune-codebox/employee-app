<template>
    <aside>
        <h3> <b>employee</b> </h3>
         <div class="nav-side">
             <!-- list-group-flush -->
            <b-navbar-nav id="sidebar-wrapper" class="list-group">
             <b-nav-item :to="{name: 'employees-overview'}" class="links">
